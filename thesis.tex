...
\begin{proof}
    ...
    $$\eta+\frac{1}{q-1}=\negl(\lambda)$$
\end{proof}
\subsubsection{Verifiability for a cheating client}
\section{Conclusion}
\newpage
\section{References}
